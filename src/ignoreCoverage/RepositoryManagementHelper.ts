...
export default class RepositoryManagementHelper  implements RepositoryManagementInterface{
  ...
  private getRepositoryImplementation(env: EnvHelper): RepositoryManagementInterface{
    let repositoryManagementName = env.getRepositoryManagementName();
    switch (repositoryManagementName){
      case GitLabHelper.ENV_NAME: return new GitLabHelper(env);
      default: return new GitHubHelper(env);
    }
  }
